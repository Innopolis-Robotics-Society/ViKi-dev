...
# ── Recording
RECORD_DEPTH = (
    False  # is depth recorded in a .npy format for each frame alongside the mp4 videos,
)
...
SKELETON_ENABLE_DEPTH_VALIDATION = (
    True  # enables this validation, disabling will lead to unstable results
)
SKELETON_DEPTH_SUBTRACT_THRESHOLD = (
    0.01  # Minimum depth difference to consider object present (meters)
)
